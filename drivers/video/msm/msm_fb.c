...
static ssize_t msm_fb_get_rgb(struct device *dev,
		struct device_attribute *attr, char *buf)
{
 ...
 */
static ssize_t msm_fb_set_rgb(struct device *dev,
							struct device_attribute *attr,
							const char *buf, size_t count)
{
...
static DEVICE_ATTR(rgb, S_IRUGO | S_IWUSR | S_IWGRP, msm_fb_get_rgb, msm_fb_set_rgb);
